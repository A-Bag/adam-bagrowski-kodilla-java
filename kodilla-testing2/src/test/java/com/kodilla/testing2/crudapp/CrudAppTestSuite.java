...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://a-bag.github.io/";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("abag1");
        driverTrello.findElement(By.id("password")).sendKeys("kodillatesting");
